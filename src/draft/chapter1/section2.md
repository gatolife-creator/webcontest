...
<span style="color:skyblue;">先生：それは、<strong>一部のコンピューターだけに負担が<span style="color:red;">かかることがないという点だ。</span></strong></span>
...
<span style="color:skyblue;">先生：その通りだ。ピア・ツー・ピア<span style="color:red;">なら</span>一部のコンピューターに障害が発生しても、他のコンピューターが動き続けているかぎり、<span style="color:red;">システムは正常に機能するのだ。</span></span>
...
<span style="color:skyblue;">生徒：出力値<span style="color:red;">からは</span>入力値を推測できないという性質が役立っていますね！</span>
...
先生：安心しろ。決して難しい仕組みではない。決して仕組みは難しくない。<strong>秘密鍵</strong>で暗号化し、<strong>公開鍵</strong>で復号するだけだ。

<span style="color:skyblue;">前者がいいと思う</span>
...
<span style="color:skyblue">下の図の②の文章の二つの鍵の順番が違うがどちらを優先しようか</span>

![公開鍵暗号方式の仕組みの図](/public/imgs/スライド3.jpeg)

<span style="color:yellow;">参考文献：https://udemy.benesse.co.jp/development/blockchain/public-key-cryptography.html</span>
...
<span style="color:skyblue">ごめん否認の防止が分からぬ</span>

先生：公開鍵で複合できるようにすることで、誰もが複合できるようにしている。

生徒：それじゃあ暗号化の意味ないじゃないですか！

先生：そこが重要なのだよ。誰もが複合できるようにすることで、誰もが署名（データ送信者の照合）を確認することができるのだ。
